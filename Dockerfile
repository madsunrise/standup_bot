...
# сборка: docker buildx build --platform linux/amd64 -t standup:v1 .
...
# Compose, запустить на сервере: docker-compose up -d (предварительно дописать в docker-compose.yml image: standup:v1)